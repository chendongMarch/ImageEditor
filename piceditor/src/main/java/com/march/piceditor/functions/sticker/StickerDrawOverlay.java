...
import com.march.piceditor.functions.sticker.gesture.impl.MoveHandler;
import com.march.piceditor.functions.sticker.gesture.impl.TwoFingersHandler;
...
public class StickerDrawOverlay extends View {
    ...
    public StickerDrawOverlay(Context context,   AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StickerDrawOverlay(Context context,    AttributeSet attrs, int defStyleAttr) {
    ...
    private SparseArray<StickerBaseTouchHandler> mTouchHandlerMap;
    ...
    */
    ...
    private void init() {
        ...
        mTouchHandlerMap = new SparseArray<>();
