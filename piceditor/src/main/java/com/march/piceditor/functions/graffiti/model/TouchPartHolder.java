package com.march.piceditor.functions.graffiti.model;
...
public class TouchPartHolder implements Comparable<TouchPartHolder> {
    ...
    private GraffitiOverlayView.TouchMode mTouchMode;
    ...
    public TouchPartHolder(GraffitiOverlayView.TouchMode touchMode) {
        mTouchMode = touchMode;
    }

    public TouchPartHolder(boolean isErase, GraffitiOverlayView.TouchMode touchMode) {
        mTouchMode = touchMode;
        mIsErase = isErase;
    }
    ...
    public void onTouchDown(MotionEvent event, int width) {
        if (mTouchMode == GraffitiOverlayView.TouchMode.PATH) {
            mPath = new Path();
            mPath.moveTo(event.getX(), event.getY());
            mPathWidth = width;
        } else if (mTouchMode == GraffitiOverlayView.TouchMode.RECT) {
...
//            mRectF.bottom = event.getY();
    ...
    @Override
    public int compareTo(TouchPartHolder o) {
